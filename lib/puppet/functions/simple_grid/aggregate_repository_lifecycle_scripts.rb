require 'yaml'
Puppet::Functions.create_function(:'simple_grid::aggregate_repository_lifecycle_scripts') do
        dispatch :aggregate_repository_lifecycle_scripts do
                param 'String', :site_level_config_file_path
        end
        def aggregate_repository_lifecycle_scripts(site_level_config_file_path)
